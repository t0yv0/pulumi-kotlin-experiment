    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:sql/v20211101:ElasticPool").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20211101preview:ElasticPool").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20220201preview:ElasticPool").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20220501preview:ElasticPool").build())
            ))
            .build();
