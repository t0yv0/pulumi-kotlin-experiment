    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                ...
                Output.of(Alias.builder().type("azure-native:sql/v20211101:ServerAzureADOnlyAuthentication").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20211101preview:ServerAzureADOnlyAuthentication").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20220201preview:ServerAzureADOnlyAuthentication").build()),
                Output.of(Alias.builder().type("azure-native:sql/v20220501preview:ServerAzureADOnlyAuthentication").build())
            ))
            .build();
