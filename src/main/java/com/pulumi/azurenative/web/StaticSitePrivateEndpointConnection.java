...
public class StaticSitePrivateEndpointConnection extends com.pulumi.resources.CustomResource {
     ...
     */
    public StaticSitePrivateEndpointConnection(String name, StaticSitePrivateEndpointConnectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
    ...
    private StaticSitePrivateEndpointConnection(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static StaticSitePrivateEndpointConnection get(String name, Output<String> id, @Nullable com.pulumi.resources.CustomResourceOptions options) {
